...
The Maze was written was written in C ussing SDL2 library. Deveploment was performed using Ubuntu 20.04.4 LTS (GNU/Linux 5.11.0-1020-gcp x86_64)
### About SDL2 
...
## Instalation 
```sh
$ git clone (https://github.com/malu17)/The-Maze.git
```
## Usage 
